...
import CartItemRow from '@/components/business/CartItem.vue'
...
<template>
  <div class="pt-[var(--header-height)] min-h-screen">
    <div class="mx-auto max-w-3xl px-6 py-16">
      ...
      <p class="text-brand-500 text-sm mb-12">
      ...
      <template v-else>
        ...
        <div class="mt-8 pt-8 border-t border-brand-200 flex justify-between items-center">
